...
/// Provides the `uint32_t` token value for a specific trace event. This
/// can be used in the callback to perform specific actions for that trace.
...
/// @endcode
///
/// The above trace ref would provide the token value for the string:
