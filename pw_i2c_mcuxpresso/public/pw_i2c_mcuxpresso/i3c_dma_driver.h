...
// Interface to the fsl_i3c_dma.c driver
//  - calls I3C_MasterTransferDMA()
class I3cDmaDriver final : public I3cDriver {
 public:
  struct DmaConfig {
  ...
  I3cDmaDriver(const DmaConfig& config);

 private:
  // I3cDriver Interface
  virtual pw::Status DoInit(I3C_Type* base) override;
  virtual void DoDeInit() override;
  virtual pw::Status DoInitiateTransferUntil(
      pw::chrono::SystemClock::time_point, i3c_master_transfer_t*) override;
  ...
  const DmaConfig& config_;

  i3c_master_dma_handle_t handle_;
  i3c_master_dma_callback_t callbacks_;
