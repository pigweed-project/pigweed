...
// The default stack size in words for test threads.
#ifndef PW_THREAD_FREERTOS_CONFIG_TEST_THREAD_STACK_SIZE_WORDS
#define PW_THREAD_FREERTOS_CONFIG_TEST_THREAD_STACK_SIZE_WORDS 8192
#endif  // PW_THREAD_FREERTOS_CONFIG_TEST_THREAD_STACK_SIZE_WORDS
static_assert(PW_THREAD_FREERTOS_CONFIG_TEST_THREAD_STACK_SIZE_WORDS >=
              configMINIMAL_STACK_SIZE);
